        ...
        <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    ...
                    <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('admin.categories.index') }}">List</a></li>

                    <li><i class="fa fa-id-badge"></i><a href="{{ route('admin.categories.create') }}">Create</a></li>
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="fa fa-table"></i><a href="{{route('admin.products.index')}}">List</a></li>
                    <li><i class="fa fa-table"></i><a href="{{route('products.create')}}">Create</a></li>
                </ul>
            </li>
            <li class="menu-item-has-children dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
